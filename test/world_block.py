...
class WorldBlockTestCase(world_creative.WorldCreativeTestCase):
    ...
    def test_put_button(self):
        ...
        self._move_player(Vector3(x=256, y=63, z=254), 0.0)  # Face.NORTH
        self._put_item(Vector3(x=256, y=62, z=255), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=256, y=63, z=255), BlockType.WOODEN_BUTTON, 1)
        self._assert_inventory_updated(item)

        self._put_item(Vector3(x=256, y=64, z=256), Vector3(0.5, 0.5, 0.0), Face.SOUTH, item)
        self._assert_block_updated(Vector3(x=256, y=64, z=255), BlockType.WOODEN_BUTTON, 2)
        self._assert_inventory_updated(item)

        self._put_item(Vector3(x=256, y=64, z=255), Vector3(0.5, 0.5, 0.0), Face.SOUTH, item)
        self._assert_block_updated(Vector3(x=256, y=64, z=255), BlockType.WOODEN_BUTTON, 10)
        self._assert_inventory_updated(item)
        ...
        self._move_player(Vector3(x=258, y=63, z=256), 90.0)  # Face.EAST
        self._put_item(Vector3(x=257, y=62, z=256), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=257, y=63, z=256), BlockType.WOODEN_BUTTON, 1)
        self._assert_inventory_updated(item)

        self._put_item(Vector3(x=256, y=64, z=256), Vector3(1.0, 0.5, 0.5), Face.WEST, item)
        self._assert_block_updated(Vector3(x=257, y=64, z=256), BlockType.WOODEN_BUTTON, 5)
        self._assert_inventory_updated(item)

        self._put_item(Vector3(x=257, y=64, z=256), Vector3(1.0, 0.5, 0.5), Face.WEST, item)
        self._assert_block_updated(Vector3(x=257, y=64, z=256), BlockType.WOODEN_BUTTON, 13)
        self._assert_inventory_updated(item)
        ...
        self._move_player(Vector3(x=256, y=63, z=258), 180.0)  # Face.SOUTH
        self._put_item(Vector3(x=256, y=62, z=257), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=256, y=63, z=257), BlockType.WOODEN_BUTTON, 1)
        self._assert_inventory_updated(item)

        self._put_item(Vector3(x=256, y=64, z=256), Vector3(0.5, 0.5, 1.0), Face.NORTH, item)
        self._assert_block_updated(Vector3(x=256, y=64, z=257), BlockType.WOODEN_BUTTON, 3)
        self._assert_inventory_updated(item)

        # put on EAST
        self._move_player(Vector3(x=254, y=63, z=256), 270.0)  # Face.WEST
        self._put_item(Vector3(x=255, y=62, z=256), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=255, y=63, z=256), BlockType.WOODEN_BUTTON, 1)
        self._assert_inventory_updated(item)
    ...
    def _test_put_wall(self, item_type: ItemType, block_type: BlockType):
        ...
        # put on SOUTH
        self._put_item(Vector3(x=256, y=64, z=256), Vector3(0.5, 0.5, 0.0), Face.SOUTH, item)
        self._assert_block_updated(Vector3(x=256, y=64, z=255), block_type, 2)
        self._assert_inventory_updated(item)

        # put on NORTH
        self._put_item(Vector3(x=256, y=64, z=256), Vector3(0.5, 0.5, 1.0), Face.NORTH, item)
        self._assert_block_updated(Vector3(x=256, y=64, z=257), block_type, 3)
        self._assert_inventory_updated(item)

        # put on EAST
        self._put_item(Vector3(x=256, y=64, z=256), Vector3(0.0, 0.5, 0.5), Face.EAST, item)
        self._assert_block_updated(Vector3(x=255, y=64, z=256), block_type, 4)
        self._assert_inventory_updated(item)

        # put on WEST
        self._put_item(Vector3(x=256, y=64, z=256), Vector3(1.0, 0.5, 0.5), Face.WEST, item)
        self._assert_block_updated(Vector3(x=257, y=64, z=256), block_type, 5)
        self._assert_inventory_updated(item)
    ...
    def _test_put_standing(self, item_type: ItemType, block_type: BlockType):
        ...
        self._move_player(Vector3(x=256, y=63, z=256), 180.0)  # Face.SOUTH
        self._put_item(Vector3(x=256, y=62, z=255), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=256, y=63, z=255), block_type, 0)
        self._assert_inventory_updated(item)

        # put on EAST
        self._move_player(Vector3(x=256, y=63, z=256), 270.0)  # Face.WEST
        self._put_item(Vector3(x=257, y=62, z=256), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=257, y=63, z=256), block_type, 4)
        self._assert_inventory_updated(item)

        # put on SOUTH
        self._move_player(Vector3(x=256, y=63, z=256), 360.0)  # Face.NORTH
        self._put_item(Vector3(x=256, y=62, z=257), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=256, y=63, z=257), block_type, 8)
        self._assert_inventory_updated(item)
    ...
    def test_put_chest(self):
        ...
        self._move_player(Vector3(x=256, y=63, z=254), 0.0)  # Face.NORTH
        self._put_item(Vector3(x=256, y=62, z=255), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=256, y=63, z=255), BlockType.CHEST, 2)
        self._assert_inventory_updated(item)

        self._put_item(Vector3(x=256, y=64, z=256), Vector3(0.5, 0.5, 0.0), Face.SOUTH, item)
        self._assert_block_updated(Vector3(x=256, y=64, z=255), BlockType.CHEST, 2)
        self._assert_inventory_updated(item)

        # put on NORTH
        self._move_player(Vector3(x=256, y=63, z=258), 180.0)  # Face.SOUTH
        self._put_item(Vector3(x=256, y=62, z=257), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=256, y=63, z=257), BlockType.CHEST, 3)
        self._assert_inventory_updated(item)

        self._put_item(Vector3(x=256, y=64, z=256), Vector3(0.5, 0.5, 1.0), Face.NORTH, item)
        self._assert_block_updated(Vector3(x=256, y=64, z=257), BlockType.CHEST, 3)
        self._assert_inventory_updated(item)

        # put on EAST
        self._move_player(Vector3(x=254, y=63, z=256), 270.0)  # Face.WEST
        self._put_item(Vector3(x=255, y=62, z=256), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=255, y=63, z=256), BlockType.CHEST, 4)
        self._assert_inventory_updated(item)

        self._put_item(Vector3(x=256, y=64, z=256), Vector3(0.0, 0.5, 0.5), Face.EAST, item)
        self._assert_block_updated(Vector3(x=255, y=64, z=256), BlockType.CHEST, 4)
        self._assert_inventory_updated(item)

        # put on WEST
        self._move_player(Vector3(x=258, y=63, z=256), 90.0)  # Face.EAST
        self._put_item(Vector3(x=257, y=62, z=256), Vector3(0.5, 1.0, 0.5), Face.TOP, item)
        self._assert_block_updated(Vector3(x=257, y=63, z=256), BlockType.CHEST, 5)
        self._assert_inventory_updated(item)

        self._put_item(Vector3(x=256, y=64, z=256), Vector3(1.0, 0.5, 0.5), Face.WEST, item)
        self._assert_block_updated(Vector3(x=257, y=64, z=256), BlockType.CHEST, 5)
        self._assert_inventory_updated(item)
